...
Feedback: To learn more about the relationship between the diameter of metal nanowires and their electrical conduction properties, review “Resource Placeholder.”""",
        ...
        "H5P Textual Upload Feature": """Exactly align the format of the question with the example below. (Each answer option should be on a separate line with an asterisk (*) at the beginning of the correct answer option. This must be exact. Do not indicate answers with alphabets.) There is no feedback here. 
